...
- **IMPORTANT: only changes to the shipped application use `feat` or `fix`.** Everything else MUST be
...
- When in doubt, ask whether the change alters what someone installing the app gets.
